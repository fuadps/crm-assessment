                                ...
                                <div className="sm:flex sm:items-center">
                                    <div className="sm:flex-auto">
                                        <p className="mt-2 text-sm text-gray-700">
                                            A list of all the employees in the database including their name, email, and company.
                                        </p>
                                    </div>
                                    ...
                                    <table className="w-full text-left">
                                        ...
                                        {data.map((employee) => (
                                            <tr key={employee.email}>
                                                ...
                                                <td className="hidden px-3 py-4 text-sm text-blue-500 underline sm:table-cell"><Link href={route('companies.edit', employee.company_id)}>{employee?.company?.name}</Link></td>
